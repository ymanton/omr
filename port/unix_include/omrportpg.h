...
typedef struct OMRPortPlatformGlobals {
	...
	int32_t cgroupVersion; /**< cgroup version number found at the cgroup mount point */
...
#define PPG_cgroupVersion (portLibrary->portGlobals->platformGlobals.cgroupVersion)
